# Problem Bank — DeepSpeed ZeRO and PyTorch FSDP

Practice problems for **DeepSpeed ZeRO and PyTorch FSDP**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_ring_allreduce_cost](p01_compute_ring_allreduce_cost.py) | DeepSpeed ZeRO and PyTorch FSDP | Medium | Production Grade |
