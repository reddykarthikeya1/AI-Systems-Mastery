# Problem Bank — Pipeline Parallelism and Schedules

Practice problems for **Pipeline Parallelism and Schedules**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_ring_allreduce_cost](p01_compute_ring_allreduce_cost.py) | Pipeline Parallelism and Schedules | Medium | Production Grade |
