...
| **4** | **[00_interactive_network_flow_and_matching.ipynb](00_interactive_network_flow_and_matching.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
