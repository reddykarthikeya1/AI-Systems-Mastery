...
| **4** | **[00_interactive_heaps_priority_queues_and_topk_patterns.ipynb](00_interactive_heaps_priority_queues_and_topk_patterns.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
