...
| **4** | **[00_interactive_backtracking_and_constraint_satisfaction.ipynb](00_interactive_backtracking_and_constraint_satisfaction.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
