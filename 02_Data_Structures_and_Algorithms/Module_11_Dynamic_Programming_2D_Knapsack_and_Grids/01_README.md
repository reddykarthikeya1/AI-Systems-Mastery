...
| **4** | **[00_interactive_dynamic_programming_2d_knapsack_and_grids.ipynb](00_interactive_dynamic_programming_2d_knapsack_and_grids.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
