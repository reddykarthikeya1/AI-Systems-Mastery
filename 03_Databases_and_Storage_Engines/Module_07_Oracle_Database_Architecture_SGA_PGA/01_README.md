...
| **4** | **[02_interactive_oracle_architecture.ipynb](02_interactive_oracle_architecture.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_oracle_sga_pga_simulation_demo.py](03_oracle_sga_pga_simulation_demo.py)** | Run in terminal (`python 03_oracle_sga_pga_simulation_demo.py`) to explore 03 Oracle Sga Pga Simulation Demo code patterns. |
