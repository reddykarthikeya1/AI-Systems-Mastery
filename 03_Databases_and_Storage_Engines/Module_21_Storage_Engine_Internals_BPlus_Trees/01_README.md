...
| **4** | **[02_interactive_bplus_trees.ipynb](02_interactive_bplus_trees.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_slotted_page_and_bplus_tree_demo.py](03_slotted_page_and_bplus_tree_demo.py)** | Run in terminal (`python 03_slotted_page_and_bplus_tree_demo.py`) to explore 03 Slotted Page And Bplus Tree Demo code patterns. |
