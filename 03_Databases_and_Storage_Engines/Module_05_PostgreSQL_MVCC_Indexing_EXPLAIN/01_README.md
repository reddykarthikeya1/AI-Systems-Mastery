...
| **4** | **[02_interactive_postgres_mvcc.ipynb](02_interactive_postgres_mvcc.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_mvcc_visibility_and_explain_demo.py](03_mvcc_visibility_and_explain_demo.py)** | Run in terminal (`python 03_mvcc_visibility_and_explain_demo.py`) to explore 03 Mvcc Visibility And Explain Demo code patterns. |
