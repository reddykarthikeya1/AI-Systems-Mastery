...
| **4** | **[02_interactive_cassandra_ring.ipynb](02_interactive_cassandra_ring.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_cassandra_ring_and_quorum_demo.py](03_cassandra_ring_and_quorum_demo.py)** | Run in terminal (`python 03_cassandra_ring_and_quorum_demo.py`) to explore 03 Cassandra Ring And Quorum Demo code patterns. |
