...
| **4** | **[02_interactive_mongo_document.ipynb](02_interactive_mongo_document.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_bson_serialization_and_schema_patterns_demo.py](03_bson_serialization_and_schema_patterns_demo.py)** | Run in terminal (`python 03_bson_serialization_and_schema_patterns_demo.py`) to explore 03 Bson Serialization And Schema Patterns Demo code patterns. |
