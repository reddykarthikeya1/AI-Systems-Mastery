# Problem Bank — MongoDB Document Modeling BSON

Practice problems for **MongoDB Document Modeling BSON**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | MongoDB Document Modeling BSON | Medium | Production Grade |
