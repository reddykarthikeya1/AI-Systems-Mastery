...
| **4** | **[02_interactive_search_elasticsearch.ipynb](02_interactive_search_elasticsearch.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_inverted_index_and_bm25_demo.py](03_inverted_index_and_bm25_demo.py)** | Run in terminal (`python 03_inverted_index_and_bm25_demo.py`) to explore 03 Inverted Index And Bm25 Demo code patterns. |
