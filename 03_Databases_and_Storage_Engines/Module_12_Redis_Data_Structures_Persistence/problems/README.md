# Problem Bank — Redis Data Structures Persistence

Practice problems for **Redis Data Structures Persistence**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | Redis Data Structures Persistence | Medium | Production Grade |
