...
| **4** | **[02_interactive_redis_structures.ipynb](02_interactive_redis_structures.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_redis_data_structures_and_aof_demo.py](03_redis_data_structures_and_aof_demo.py)** | Run in terminal (`python 03_redis_data_structures_and_aof_demo.py`) to explore 03 Redis Data Structures And Aof Demo code patterns. |
