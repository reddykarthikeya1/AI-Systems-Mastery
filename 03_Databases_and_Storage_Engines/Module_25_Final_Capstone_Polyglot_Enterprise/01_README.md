...
| **4** | **[02_interactive_polyglot_platform.ipynb](02_interactive_polyglot_platform.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_polyglot_architecture_demo.py](03_polyglot_architecture_demo.py)** | Run in terminal (`python 03_polyglot_architecture_demo.py`) to explore 03 Polyglot Architecture Demo code patterns. |
