...
| **4** | **[02_interactive_transactions_consensus.ipynb](02_interactive_transactions_consensus.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_write_skew_and_raft_consensus_demo.py](03_write_skew_and_raft_consensus_demo.py)** | Run in terminal (`python 03_write_skew_and_raft_consensus_demo.py`) to explore 03 Write Skew And Raft Consensus Demo code patterns. |
