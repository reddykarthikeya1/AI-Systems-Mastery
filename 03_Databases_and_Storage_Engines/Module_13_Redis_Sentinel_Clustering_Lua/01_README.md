...
| **4** | **[02_interactive_redis_cluster.ipynb](02_interactive_redis_cluster.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_sentinel_clustering_streams_demo.py](03_sentinel_clustering_streams_demo.py)** | Run in terminal (`python 03_sentinel_clustering_streams_demo.py`) to explore 03 Sentinel Clustering Streams Demo code patterns. |
...
Welcome to **Module 13**. In this module, you will master enterprise-grade distributed Redis: achieving high availability with **Redis Sentinel**, horizontal scale-out with **Redis Cluster (16,384 Hash Slots)**, zero-race-condition transactions with **Lua Scripting**, and event-driven architectures with **Redis Streams & Consumer Groups**.
