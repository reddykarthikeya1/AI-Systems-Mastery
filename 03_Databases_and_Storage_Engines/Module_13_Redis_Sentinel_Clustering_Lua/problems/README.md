# Problem Bank — Redis Sentinel Clustering Lua

Practice problems for **Redis Sentinel Clustering Lua**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | Redis Sentinel Clustering Lua | Medium | Production Grade |
