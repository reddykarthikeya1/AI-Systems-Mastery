# Problem Bank — Neo4j Graph Databases Cypher

Practice problems for **Neo4j Graph Databases Cypher**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | Neo4j Graph Databases Cypher | Medium | Production Grade |
