...
- **Affected Subsystem:** Module 16 Neo4j Graph Databases Cypher
...
1. Navigate to this module's debug lab:
   ```bash
   cd Module_16_Neo4j_Graph_Databases_Cypher/debug_lab
   ```
2. Run the repro script:
   ```bash
   python broken_cypher_match.py
   ```
3. Observe the crash or invariant failure.

### 🎯 Your Objective
1. Inspect `broken_cypher_match.py` to identify the root cause.
