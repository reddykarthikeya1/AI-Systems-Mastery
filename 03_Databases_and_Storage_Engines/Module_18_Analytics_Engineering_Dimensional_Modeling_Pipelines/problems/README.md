# Problem Bank — Analytics Engineering Dimensional Modeling Pipelines

Practice problems for **Analytics Engineering Dimensional Modeling Pipelines**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | Analytics Engineering Dimensional Modeling Pipelines | Medium | Production Grade |
...
| :---: | :--- | :--- |
| **1** | **Read Requirements** | Review problem docstrings and invariants in `[p01_compute_storage_layout.py](p01_compute_storage_layout.py)`. |
