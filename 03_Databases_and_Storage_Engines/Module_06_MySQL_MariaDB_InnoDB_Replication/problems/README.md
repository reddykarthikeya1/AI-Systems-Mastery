# Problem Bank — MySQL MariaDB InnoDB Replication

Practice problems for **MySQL MariaDB InnoDB Replication**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | MySQL MariaDB InnoDB Replication | Medium | Production Grade |
