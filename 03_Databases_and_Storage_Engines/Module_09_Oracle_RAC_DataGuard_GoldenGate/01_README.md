...
| **4** | **[02_interactive_oracle_ha.ipynb](02_interactive_oracle_ha.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_oracle_rac_dataguard_demo.py](03_oracle_rac_dataguard_demo.py)** | Run in terminal (`python 03_oracle_rac_dataguard_demo.py`) to explore 03 Oracle Rac Dataguard Demo code patterns. |
