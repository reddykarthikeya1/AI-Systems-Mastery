# Problem Bank — Oracle RAC DataGuard GoldenGate

Practice problems for **Oracle RAC DataGuard GoldenGate**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | Oracle RAC DataGuard GoldenGate | Medium | Production Grade |
