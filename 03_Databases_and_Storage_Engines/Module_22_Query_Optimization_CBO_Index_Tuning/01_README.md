...
| **4** | **[02_interactive_query_optimization.ipynb](02_interactive_query_optimization.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_query_optimizer_cbo_and_joins_demo.py](03_query_optimizer_cbo_and_joins_demo.py)** | Run in terminal (`python 03_query_optimizer_cbo_and_joins_demo.py`) to explore 03 Query Optimizer Cbo And Joins Demo code patterns. |
