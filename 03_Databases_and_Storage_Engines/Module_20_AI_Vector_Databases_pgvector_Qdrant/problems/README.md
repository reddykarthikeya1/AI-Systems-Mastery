# Problem Bank — AI Vector Databases pgvector Qdrant

Practice problems for **AI Vector Databases pgvector Qdrant**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | AI Vector Databases pgvector Qdrant | Medium | Production Grade |
