# Problem Bank — Columnar OLAP DuckDB ClickHouse

Practice problems for **Columnar OLAP DuckDB ClickHouse**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | Columnar OLAP DuckDB ClickHouse | Medium | Production Grade |
