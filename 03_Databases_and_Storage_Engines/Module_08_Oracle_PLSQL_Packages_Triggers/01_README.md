...
| **4** | **[02_interactive_oracle_plsql.ipynb](02_interactive_oracle_plsql.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_plsql_bulk_collect_and_autonomous_demo.py](03_plsql_bulk_collect_and_autonomous_demo.py)** | Run in terminal (`python 03_plsql_bulk_collect_and_autonomous_demo.py`) to explore 03 Plsql Bulk Collect And Autonomous Demo code patterns. |
