# Problem Bank — Oracle PLSQL Packages Triggers

Practice problems for **Oracle PLSQL Packages Triggers**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | Oracle PLSQL Packages Triggers | Medium | Production Grade |
