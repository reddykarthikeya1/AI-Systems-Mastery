...
| **4** | **[02_interactive_mongo_aggregation.ipynb](02_interactive_mongo_aggregation.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_mongodb_aggregation_and_sharding_demo.py](03_mongodb_aggregation_and_sharding_demo.py)** | Run in terminal (`python 03_mongodb_aggregation_and_sharding_demo.py`) to explore 03 Mongodb Aggregation And Sharding Demo code patterns. |
