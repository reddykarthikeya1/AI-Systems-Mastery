# Problem Bank — MongoDB Aggregations Replicas Sharding

Practice problems for **MongoDB Aggregations Replicas Sharding**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_storage_layout](p01_compute_storage_layout.py) | MongoDB Aggregations Replicas Sharding | Medium | Production Grade |
