...
| **4** | **[02_interactive_dynamodb_lsm.ipynb](02_interactive_dynamodb_lsm.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_lsm_tree_and_bloom_filter_demo.py](03_lsm_tree_and_bloom_filter_demo.py)** | Run in terminal (`python 03_lsm_tree_and_bloom_filter_demo.py`) to explore 03 Lsm Tree And Bloom Filter Demo code patterns. |
...
Welcome to **Module 15**. In this module, you will master **Log-Structured Merge-Trees (LSM-Trees)** — the foundational storage engine architecture powering high-throughput write-heavy systems including RocksDB, LevelDB, Apache Cassandra, ScyllaDB, CockroachDB, and Google Bigtable — alongside AWS's fully managed NoSQL service, **Amazon DynamoDB**.
