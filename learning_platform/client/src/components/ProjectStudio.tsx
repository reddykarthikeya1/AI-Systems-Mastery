            ...
            <div className="rounded-2xl bg-[#0D1117] border border-zinc-800 shadow-xl overflow-hidden flex flex-col">
              ...
              <div className="flex items-center justify-between px-3 py-2 bg-[#161B22] border-b border-zinc-800 overflow-x-auto gap-2 select-none">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  {/* Font Size Toggle */}
                  <div className="flex items-center bg-zinc-900 rounded-lg p-0.5 border border-zinc-800 text-[10px] font-mono text-zinc-400">
                    <button
              ...
              <div className="flex items-center justify-between px-4 py-2 bg-[#161B22] border-t border-zinc-800 text-[11px] font-mono text-zinc-400 select-none">
              ...
              <div className="p-4 bg-zinc-950 font-mono text-xs text-zinc-300 max-h-72 overflow-y-auto">
                  ...
                  <div>
                    {!testResult && !isRunningTests && (
                      <div className="text-zinc-500 py-6 text-center">
                        ...
                        <p className="text-[11px] text-zinc-600 mt-0.5">Click "Run Tests (Ctrl+Enter)" above to execute automated pytest verification.</p>
                      </div>
                    )}
                    {isRunningTests && (
                ...
                {activeTerminalTab === 'diff' && activeFile?.solution_content && (
                  <div className="space-y-3">
                    <div className="text-[11px] text-amber-400 flex items-center gap-1.5 pb-2 border-b border-zinc-800">
