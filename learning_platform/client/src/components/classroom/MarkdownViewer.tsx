        ...
        <>
          ...
          {isAlgorithmic && (
            <div className="mb-6 p-4 rounded-2xl bg-sky-500/10 border border-sky-500/20 flex items-center justify-between gap-4">
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl text-xs font-mono font-bold bg-sky-500 hover:bg-sky-600 text-white transition-colors shadow-sm"
              >
          ...
          <div className="mt-12 p-5 rounded-2xl bg-zinc-50/70 dark:bg-zinc-900/40 border border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => onConfidenceClick(5, '🟢 Solid retention scheduled (5/5)')}
              ...
              <button
                onClick={() => onConfidenceClick(3, '🟡 Review scheduled for tomorrow (3/5)')}
              ...
              <button
                onClick={() => onConfidenceClick(1, '🔴 Reset for immediate review today (1/5)')}
      ...
      <div className="mt-12 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4 sticky bottom-4 bg-surface/95 backdrop-blur-md p-4 rounded-2xl border border-border shadow-xl z-20">
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <button
            ...
            disabled={!prevLesson}
            className="flex-1 sm:flex-initial px-4 py-2.5 rounded-xl border border-border bg-zinc-50 dark:bg-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-800 disabled:opacity-30 disabled:pointer-events-none transition-colors text-xs font-medium text-fg-muted flex items-center gap-2 shadow-sm"
          >
