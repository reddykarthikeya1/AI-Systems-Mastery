# Problem Bank — Speculative Decoding Architectures

Practice problems for **Speculative Decoding Architectures**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [simulate_prefix_cache_hit](p01_simulate_prefix_cache_hit.py) | Speculative Decoding Architectures | Medium | Production Grade |
