# Problem Bank — RadixAttention and Prefix Caching

Practice problems for **RadixAttention and Prefix Caching**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [simulate_prefix_cache_hit](p01_simulate_prefix_cache_hit.py) | RadixAttention and Prefix Caching | Medium | Production Grade |
