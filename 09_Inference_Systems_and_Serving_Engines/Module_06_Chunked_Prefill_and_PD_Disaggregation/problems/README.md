# Problem Bank — Chunked Prefill and PD Disaggregation

Practice problems for **Chunked Prefill and PD Disaggregation**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [simulate_prefix_cache_hit](p01_simulate_prefix_cache_hit.py) | Chunked Prefill and PD Disaggregation | Medium | Production Grade |
