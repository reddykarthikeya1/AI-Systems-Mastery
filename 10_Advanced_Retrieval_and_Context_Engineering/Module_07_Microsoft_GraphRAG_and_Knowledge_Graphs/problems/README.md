# Problem Bank — Microsoft GraphRAG and Knowledge Graphs

Practice problems for **Microsoft GraphRAG and Knowledge Graphs**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_rrf_scores](p01_compute_rrf_scores.py) | Microsoft GraphRAG and Knowledge Graphs | Medium | Production Grade |
