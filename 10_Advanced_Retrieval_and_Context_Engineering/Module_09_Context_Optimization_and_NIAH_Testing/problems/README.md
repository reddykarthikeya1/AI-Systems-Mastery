# Problem Bank — Context Optimization and NIAH Testing

Practice problems for **Context Optimization and NIAH Testing**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_rrf_scores](p01_compute_rrf_scores.py) | Context Optimization and NIAH Testing | Medium | Production Grade |
