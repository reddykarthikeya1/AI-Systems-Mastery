# Problem Bank — ColBERTv2 and Late Interaction

Practice problems for **ColBERTv2 and Late Interaction**, designed to build first-principles engineering competence through hands-on implementation and automated test verification.
...
| :--- | :--- | :--- | :--- | :--- |
| 01 | [compute_rrf_scores](p01_compute_rrf_scores.py) | ColBERTv2 and Late Interaction | Medium | Production Grade |
