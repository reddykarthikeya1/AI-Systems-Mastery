...
| **4** | **[03_interactive_loss_landscapes.ipynb](03_interactive_loss_landscapes.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[01_Functions_of_Several_Variables.md](lessons/01_Functions_of_Several_Variables.md)** | Complete deep-dive curriculum lesson on 01 Functions Of Several Variables. |
| **6** | **[02_Level_Sets_and_Contour_Plots.md](lessons/02_Level_Sets_and_Contour_Plots.md)** | Complete deep-dive curriculum lesson on 02 Level Sets And Contour Plots. |
| **7** | **[03_Limits_in_Several_Variables.md](lessons/03_Limits_in_Several_Variables.md)** | Complete deep-dive curriculum lesson on 03 Limits In Several Variables. |
