...
| **4** | **[04_interactive_metaprogramming.ipynb](04_interactive_metaprogramming.ipynb)** | Open in VS Code/Jupyter to run interactive visual experiments. |
| **5** | **[05_descriptors_protocol_demo.py](05_descriptors_protocol_demo.py)** | Run in terminal (`python 05_descriptors_protocol_demo.py`) to explore Descriptors Protocol code patterns. |
| **6** | **[06_metaclasses_and_init_subclass_demo.py](06_metaclasses_and_init_subclass_demo.py)** | Run in terminal (`python 06_metaclasses_and_init_subclass_demo.py`) to explore Metaclasses And Init Subclass code patterns. |
