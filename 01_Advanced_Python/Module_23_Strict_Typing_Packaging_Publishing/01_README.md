...
| **4** | **[04_interactive_strict_typing.ipynb](04_interactive_strict_typing.ipynb)** | Open in VS Code/Jupyter to run interactive visual experiments. |
| **5** | **[05_generics_and_protocols_demo.py](05_generics_and_protocols_demo.py)** | Run in terminal (`python 05_generics_and_protocols_demo.py`) to explore Generics And Protocols code patterns. |
| **6** | **[06_pyproject_toml_packaging_demo.md](06_pyproject_toml_packaging_demo.md)** | Run in terminal (`python 06_pyproject_toml_packaging_demo.md`) to explore Pyproject Toml Packaging code patterns. |
