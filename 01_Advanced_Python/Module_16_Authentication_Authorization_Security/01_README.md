...
| **6** | **[06_jwt_tokens_and_rbac_demo.py](06_jwt_tokens_and_rbac_demo.py)** | Run in terminal (`python 06_jwt_tokens_and_rbac_demo.py`) to explore Jwt Tokens And Rbac code patterns. |
