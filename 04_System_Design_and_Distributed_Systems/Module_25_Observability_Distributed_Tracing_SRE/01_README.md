# Module 25: Observability, Distributed Tracing & SRE Resilience
...
| **4** | **[02_interactive_resilience_telemetry.ipynb](02_interactive_resilience_telemetry.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_distributed_tracing_demo.py](03_distributed_tracing_demo.py)** | Run in terminal (`python 03_distributed_tracing_demo.py`) to explore 03 Distributed Tracing Demo code patterns. |
...
SRE resilience unifies metrics, structured logging, and W3C distributed tracing with Three-State Circuit Breakers to detect regressions and prevent cascading failures.
...
```bash
jupyter notebook 00_interactive_resilience_telemetry.ipynb
```

### 2. Execute the Standalone Demo Script
Observe the components interacting under simulated workload:
```bash
python 01_distributed_tracing_demo.py
```
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_resilience_telemetry.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_distributed_tracing_demo.py`](03_distributed_tracing_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/resilience_telemetry.py`](project_solution/resilience_telemetry.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/resilience_telemetry.py`](starter/resilience_telemetry.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ➡️ Next Steps
- [Next Module: Module 26 Capstone Payment Gateway AI Fraud](../Module_26_Capstone_Payment_Gateway_AI_Fraud/01_README.md)
