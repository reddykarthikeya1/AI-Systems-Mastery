# Module 04: Load Balancing Algorithms, Health Probes & Session Affinity
...
| **4** | **[02_interactive_load_balancer.ipynb](02_interactive_load_balancer.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_load_balancer_demo.py](03_load_balancer_demo.py)** | Run in terminal (`python 03_load_balancer_demo.py`) to explore 03 Load Balancer Demo code patterns. |
...
Load balancers distribute traffic across pools of application servers using Round-Robin, Least Connections, and IP Hashing while monitoring backend health with active and passive probes.
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_load_balancer.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_load_balancer_demo.py`](03_load_balancer_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/load_balancer.py`](project_solution/load_balancer.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/load_balancer.py`](starter/load_balancer.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ➡️ Next Steps
- [Next Module: Module 05 SOLID Principles Clean Architecture](../Module_05_SOLID_Principles_Clean_Architecture/01_README.md)
