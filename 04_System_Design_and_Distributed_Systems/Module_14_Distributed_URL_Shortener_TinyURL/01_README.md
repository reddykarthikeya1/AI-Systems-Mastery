...
| **4** | **[02_interactive_url_shortener_service.ipynb](02_interactive_url_shortener_service.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_base62_keygen_demo.py](03_base62_keygen_demo.py)** | Run in terminal (`python 03_base62_keygen_demo.py`) to explore 03 Base62 Keygen Demo code patterns. |
