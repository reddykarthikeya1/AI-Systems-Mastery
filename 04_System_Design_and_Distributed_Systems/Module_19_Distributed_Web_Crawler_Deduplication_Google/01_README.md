# Module 19: System Design Case Study: Distributed Web Crawler (Google)
...
| **4** | **[02_interactive_web_crawler_frontier.ipynb](02_interactive_web_crawler_frontier.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_politeness_frontier_demo.py](03_politeness_frontier_demo.py)** | Run in terminal (`python 03_politeness_frontier_demo.py`) to explore 03 Politeness Frontier Demo code patterns. |
...
Web crawlers traverse billions of URLs while enforcing host politeness queues, parsing robots.txt, avoiding spider traps, and deduplicating pages using 64-bit SimHash.
...
```bash
jupyter notebook 00_interactive_web_crawler_frontier.ipynb
```

### 2. Execute the Standalone Demo Script
Observe the components interacting under simulated workload:
```bash
python 01_politeness_frontier_demo.py
```
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_web_crawler_frontier.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_politeness_frontier_demo.py`](03_politeness_frontier_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/web_crawler_frontier.py`](project_solution/web_crawler_frontier.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/web_crawler_frontier.py`](starter/web_crawler_frontier.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ➡️ Next Steps
- [Next Module: Module 20 Flash Sale Inventory Reservation Amazon](../Module_20_Flash_Sale_Inventory_Reservation_Amazon/01_README.md)
