# Module 26: Enterprise Capstone: Payment Gateway Platform & Real-Time AI Fraud Detection
...
| **4** | **[02_interactive_payment_gateway_platform.ipynb](02_interactive_payment_gateway_platform.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_payment_lifecycle_fraud_demo.py](03_payment_lifecycle_fraud_demo.py)** | Run in terminal (`python 03_payment_lifecycle_fraud_demo.py`) to explore 03 Payment Lifecycle Fraud Demo code patterns. |
...
The enterprise capstone unifies immutable double-entry financial bookkeeping, distributed idempotency, real-time AI fraud risk scoring, and transactional event dispatching.
...
```bash
jupyter notebook 00_interactive_payment_gateway_platform.ipynb
```

### 2. Execute the Standalone Demo Script
Observe the components interacting under simulated workload:
```bash
python 01_payment_lifecycle_fraud_demo.py
```
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_payment_gateway_platform.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_payment_lifecycle_fraud_demo.py`](03_payment_lifecycle_fraud_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/payment_gateway_platform.py`](project_solution/payment_gateway_platform.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/payment_gateway_platform.py`](starter/payment_gateway_platform.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
- [Prerequisite: Module 23 Distributed Transactions Sagas Outbox](../Module_23_Distributed_Transactions_Sagas_Outbox/01_README.md)
- [Prerequisite: Module 24 Distributed Consensus Raft Vector Clocks](../Module_24_Distributed_Consensus_Raft_Vector_Clocks/01_README.md)
- [Prerequisite: Module 25 Observability Distributed Tracing SRE](../Module_25_Observability_Distributed_Tracing_SRE/01_README.md)

### ➡️ Next Steps
- *Course Complete! Proceed to Master Capstone Evaluation.*

### 🏁 Phase Benchmark & Core Frameworks
- **[Relevant Phase Benchmark Checkpoint](../Phase_Checkpoints/PHASE_6_CHECKPOINT.md)**
