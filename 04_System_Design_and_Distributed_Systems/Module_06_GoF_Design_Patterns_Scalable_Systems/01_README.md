...
| **4** | **[02_interactive_notification_engine.ipynb](02_interactive_notification_engine.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_gof_patterns_demo.py](03_gof_patterns_demo.py)** | Run in terminal (`python 03_gof_patterns_demo.py`) to explore 03 Gof Patterns Demo code patterns. |
