# Module 20: System Design Case Study: Flash Sale & Inventory Reservation (Amazon/Taobao)
...
| **4** | **[02_interactive_flash_sale_engine.ipynb](02_interactive_flash_sale_engine.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_overselling_race_demo.py](03_overselling_race_demo.py)** | Run in terminal (`python 03_overselling_race_demo.py`) to explore 03 Overselling Race Demo code patterns. |
...
Flash sale platforms prevent overselling under extreme concurrency by issuing atomic inventory tokens with TTL leases and background rollback reapers.
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_flash_sale_engine.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_overselling_race_demo.py`](03_overselling_race_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/flash_sale_engine.py`](project_solution/flash_sale_engine.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/flash_sale_engine.py`](starter/flash_sale_engine.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ➡️ Next Steps
- [Next Module: Module 21 Vector Database HNSW Index Milvus](../Module_21_Vector_Database_HNSW_Index_Milvus/01_README.md)
