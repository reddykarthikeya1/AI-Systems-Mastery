# Module 07: Low-Level Design: State Machines & Elevator LOOK Scheduling
...
| **4** | **[02_interactive_elevator_system.ipynb](02_interactive_elevator_system.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_elevator_scheduling_demo.py](03_elevator_scheduling_demo.py)** | Run in terminal (`python 03_elevator_scheduling_demo.py`) to explore 03 Elevator Scheduling Demo code patterns. |
...
Finite state machines and SCAN/LOOK elevator disk-scheduling algorithms prevent starvation and optimize concurrent resource dispatch under strict directional invariants.
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_elevator_system.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_elevator_scheduling_demo.py`](03_elevator_scheduling_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/elevator_system.py`](project_solution/elevator_system.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/elevator_system.py`](starter/elevator_system.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ⬅️ Prerequisites
- [Prerequisite: Module 06 GoF Design Patterns Scalable Systems](../Module_06_GoF_Design_Patterns_Scalable_Systems/01_README.md)

### ➡️ Next Steps
- [Next Module: Module 08 LLD Financial Engines Splitwise Rate Limiting](../Module_08_LLD_Financial_Engines_Splitwise_Rate_Limiting/01_README.md)
