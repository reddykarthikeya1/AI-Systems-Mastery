# Module 08: Low-Level Design: Splitwise Debt Simplification & Rate Limiting
...
| **4** | **[02_interactive_splitwise_engine.ipynb](02_interactive_splitwise_engine.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_rate_limiter_algorithms_demo.py](03_rate_limiter_algorithms_demo.py)** | Run in terminal (`python 03_rate_limiter_algorithms_demo.py`) to explore 03 Rate Limiter Algorithms Demo code patterns. |
...
Financial balance tracking requires exact penny-rounding conservation, greedy debt graph minimization, and thread-safe Token Bucket rate limiters to protect transactional endpoints.
...
```bash
jupyter notebook 00_interactive_splitwise_engine.ipynb
```

### 2. Execute the Standalone Demo Script
Observe the components interacting under simulated workload:
```bash
python 01_rate_limiter_algorithms_demo.py
```
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_splitwise_engine.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_rate_limiter_algorithms_demo.py`](03_rate_limiter_algorithms_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/splitwise_engine.py`](project_solution/splitwise_engine.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/splitwise_engine.py`](starter/splitwise_engine.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ⬅️ Prerequisites
- [Prerequisite: Module 07 LLD State Machines Scheduling Elevator Parking](../Module_07_LLD_State_Machines_Scheduling_Elevator_Parking/01_README.md)

### ➡️ Next Steps
- [Next Module: Module 09 Consistent Hashing Distributed Partitioning](../Module_09_Consistent_Hashing_Distributed_Partitioning/01_README.md)
