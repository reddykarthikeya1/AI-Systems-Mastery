# Module_08: Self-Assessment, Architectural Questions & Challenges

Evaluate your mastery of **LLD Financial Engines Splitwise Rate Limiting** through diagnostic interview questions, architectural trade-off evaluations, and hands-on coding challenges.
...
What is the primary physical constraint (CPU, Memory, Disk I/O, or Network) that LLD Financial Engines Splitwise Rate Limiting is engineered to optimize or protect? Explain the trade-off.
...
Describe a common rookie implementation mistake when deploying LLD Financial Engines Splitwise Rate Limiting in production, and explain why it causes catastrophic failure under high load.
...
Implement a production-grade utility function or state tracker relevant to LLD Financial Engines Splitwise Rate Limiting adhering to defensive programming and edge-case handling.
