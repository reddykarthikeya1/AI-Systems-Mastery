# Module 05: SOLID Principles & Clean Architecture for Scalable Systems
...
| **4** | **[02_interactive_clean_checkout.ipynb](02_interactive_clean_checkout.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_solid_anti_patterns_demo.py](03_solid_anti_patterns_demo.py)** | Run in terminal (`python 03_solid_anti_patterns_demo.py`) to explore 03 Solid Anti Patterns Demo code patterns. |
...
Clean Architecture and Domain-Driven Design isolate business logic from databases and frameworks, enforcing immutable value objects, aggregate roots, and transactional consistency boundaries.
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_clean_checkout.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_solid_anti_patterns_demo.py`](03_solid_anti_patterns_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/clean_checkout.py`](project_solution/clean_checkout.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/clean_checkout.py`](starter/clean_checkout.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ➡️ Next Steps
- [Next Module: Module 06 GoF Design Patterns Scalable Systems](../Module_06_GoF_Design_Patterns_Scalable_Systems/01_README.md)
