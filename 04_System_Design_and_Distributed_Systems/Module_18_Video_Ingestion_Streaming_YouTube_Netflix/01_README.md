...
| **4** | **[02_interactive_video_pipeline.ipynb](02_interactive_video_pipeline.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_adaptive_bitrate_demo.py](03_adaptive_bitrate_demo.py)** | Run in terminal (`python 03_adaptive_bitrate_demo.py`) to explore 03 Adaptive Bitrate Demo code patterns. |
...
Video streaming pipelines ingest large files via multipart uploads, transcode resolutions across asynchronous DAGs, and package media into HLS adaptive bitrate manifests.
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_video_pipeline.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_adaptive_bitrate_demo.py`](03_adaptive_bitrate_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/video_pipeline.py`](project_solution/video_pipeline.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/video_pipeline.py`](starter/video_pipeline.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ⬅️ Prerequisites
- [Prerequisite: Module 03 Edge Infrastructure Reverse Proxies](../Module_03_Edge_Infrastructure_Reverse_Proxies/01_README.md)
...
### ➡️ Next Steps
- [Next Module: Module 19 Distributed Web Crawler Deduplication Google](../Module_19_Distributed_Web_Crawler_Deduplication_Google/01_README.md)
