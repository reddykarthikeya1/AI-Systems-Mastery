# Module 17: System Design Case Study: Geospatial Ride-Sharing Dispatch (Uber/Lyft)
...
| **4** | **[02_interactive_geospatial_dispatch.ipynb](02_interactive_geospatial_dispatch.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_geohash_spatial_demo.py](03_geohash_spatial_demo.py)** | Run in terminal (`python 03_geohash_spatial_demo.py`) to explore 03 Geohash Spatial Demo code patterns. |
...
Geospatial ride matching processes continuous driver GPS updates using Geohash spatial indexes, 8-neighbor boundary expansion, and Haversine distance ranking.
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_geospatial_dispatch.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_geohash_spatial_demo.py`](03_geohash_spatial_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/geospatial_dispatch.py`](project_solution/geospatial_dispatch.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/geospatial_dispatch.py`](starter/geospatial_dispatch.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ➡️ Next Steps
- [Next Module: Module 18 Video Ingestion Streaming YouTube Netflix](../Module_18_Video_Ingestion_Streaming_YouTube_Netflix/01_README.md)
