# Module 24: Distributed Consensus: Raft Protocol & Vector Clocks
...
| **4** | **[02_interactive_raft_cluster_engine.ipynb](02_interactive_raft_cluster_engine.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_vector_clocks_demo.py](03_vector_clocks_demo.py)** | Run in terminal (`python 03_vector_clocks_demo.py`) to explore 03 Vector Clocks Demo code patterns. |
...
Distributed consensus guarantees linearizable state machine replication across server crashes using Raft leader election, heartbeats, and majority quorum log replication.
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_raft_cluster_engine.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_vector_clocks_demo.py`](03_vector_clocks_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/raft_cluster_engine.py`](project_solution/raft_cluster_engine.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/raft_cluster_engine.py`](starter/raft_cluster_engine.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ➡️ Next Steps
- [Next Module: Module 25 Observability Distributed Tracing SRE](../Module_25_Observability_Distributed_Tracing_SRE/01_README.md)
