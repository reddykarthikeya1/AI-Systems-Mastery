...
| **4** | **[02_interactive_rpc_protocol_engine.ipynb](02_interactive_rpc_protocol_engine.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_protocol_comparisons_demo.py](03_protocol_comparisons_demo.py)** | Run in terminal (`python 03_protocol_comparisons_demo.py`) to explore 03 Protocol Comparisons Demo code patterns. |
...
Transport protocols dictate latency and throughput across distributed topologies. Choosing between TCP, UDP, QUIC, HTTP/2, HTTP/3, and gRPC impacts connection setup, multiplexing, and head-of-line blocking.
...
```bash
jupyter notebook 00_interactive_rpc_protocol_engine.ipynb
```

### 2. Execute the Standalone Demo Script
Observe the components interacting under simulated workload:
```bash
python 01_protocol_comparisons_demo.py
```
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_rpc_protocol_engine.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_protocol_comparisons_demo.py`](03_protocol_comparisons_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/rpc_protocol_engine.py`](project_solution/rpc_protocol_engine.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/rpc_protocol_engine.py`](starter/rpc_protocol_engine.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ➡️ Next Steps
- [Next Module: Module 03 Edge Infrastructure Reverse Proxies](../Module_03_Edge_Infrastructure_Reverse_Proxies/01_README.md)
