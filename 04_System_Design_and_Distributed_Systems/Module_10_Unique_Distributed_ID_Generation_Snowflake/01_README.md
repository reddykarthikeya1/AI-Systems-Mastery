# Module 10: Distributed Unique ID Generation: Twitter Snowflake
...
| **4** | **[02_interactive_snowflake_generator.ipynb](02_interactive_snowflake_generator.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_snowflake_bit_manipulation_demo.py](03_snowflake_bit_manipulation_demo.py)** | Run in terminal (`python 03_snowflake_bit_manipulation_demo.py`) to explore 03 Snowflake Bit Manipulation Demo code patterns. |
...
Twitter Snowflake generates 64-bit, time-sortable, monotonic unique IDs across distributed nodes without centralized database locks or coordination bottlenecks.
...
```bash
jupyter notebook 00_interactive_snowflake_generator.ipynb
```

### 2. Execute the Standalone Demo Script
Observe the components interacting under simulated workload:
```bash
python 01_snowflake_bit_manipulation_demo.py
```
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_snowflake_generator.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_snowflake_bit_manipulation_demo.py`](03_snowflake_bit_manipulation_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/snowflake_generator.py`](project_solution/snowflake_generator.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/snowflake_generator.py`](starter/snowflake_generator.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ➡️ Next Steps
- [Next Module: Module 11 Distributed Caching Stampede Prevention](../Module_11_Distributed_Caching_Stampede_Prevention/01_README.md)
