# Module 23: Distributed Transactions: Saga Orchestration & Transactional Outbox
...
| **4** | **[02_interactive_saga_orchestrator.ipynb](02_interactive_saga_orchestrator.ipynb)** | Open in Jupyter/VS Code to run interactive visual experiments and benchmarks. |
| **5** | **[03_saga_orchestrator_demo.py](03_saga_orchestrator_demo.py)** | Run in terminal (`python 03_saga_orchestrator_demo.py`) to explore 03 Saga Orchestrator Demo code patterns. |
...
Distributed transactions replace blocking Two-Phase Commit with Orchestrated Sagas and compensating actions, pairing with the Transactional Outbox pattern to eliminate dual-write inconsistencies.
...
| :--- | :--- |
| **[`00_interactive_*.ipynb`](02_interactive_saga_orchestrator.ipynb)** | Interactive hands-on simulation notebook with runnable visualization cells. |
| **[`03_saga_orchestrator_demo.py`](03_saga_orchestrator_demo.py)** | Standalone Python executable demonstrating core mechanics and latency profiles. |
...
| **[`project_solution/saga_orchestrator.py`](project_solution/saga_orchestrator.py)** | Verified, complete in-process architectural simulation reference model. |
| **[`starter/saga_orchestrator.py`](starter/saga_orchestrator.py)** | Student boilerplate raising `NotImplementedError` for TDD mastery. |
...
### ➡️ Next Steps
- [Next Module: Module 24 Distributed Consensus Raft Vector Clocks](../Module_24_Distributed_Consensus_Raft_Vector_Clocks/01_README.md)
