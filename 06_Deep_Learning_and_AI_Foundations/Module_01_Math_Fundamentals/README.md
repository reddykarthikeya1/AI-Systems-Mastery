...
| **4** | **[01_What_Math_You_Actually_Need_and_What_You_Do_Not.md](lessons/01_What_Math_You_Actually_Need_and_What_You_Do_Not.md)** | Complete deep-dive curriculum lesson on 01 What Math You Actually Need And What You Do Not. |
| **5** | **[02_Vectors_Matrices_and_Shapes.md](lessons/02_Vectors_Matrices_and_Shapes.md)** | Complete deep-dive curriculum lesson on 02 Vectors Matrices And Shapes. |
| **6** | **[03_Matrix_Multiplication_and_Broadcasting.md](lessons/03_Matrix_Multiplication_and_Broadcasting.md)** | Complete deep-dive curriculum lesson on 03 Matrix Multiplication And Broadcasting. |
| **7** | **[04_Dot_Products_Norms_and_Similarity.md](lessons/04_Dot_Products_Norms_and_Similarity.md)** | Complete deep-dive curriculum lesson on 04 Dot Products Norms And Similarity. |
